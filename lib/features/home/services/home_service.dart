...
import 'package:paypath_last/features/home/screens/transfer_success_screen.dart';
import 'package:paypath_last/features/transactions/models/transactions.dart';
import 'package:paypath_last/features/transactions/models/transfer.dart';
          ...
          onSuccess: () {
            ...
            Navigator.pushReplacement(
                ...
                MaterialPageRoute(builder: (context) => TransferSuccessScreen(
                  amount: amount,
                  receiverName: recipientsUsername,
                ),)
            );
          //   showAlertMessage(
          //       context: context,
